  ...
  return (
    <div>
      ...
      <div className="relative bg-black">
        ...
        />
        <div className="absolute top-1/3 mt-24 left-1/2 transform -translate-x-1/2 -translate-y-1/2 text-white sm:text-left sm:mt-4 text-center md:justify-center lg:justify-center align-middle rounded-md">
          <div className="sm:mt-1">
            ...
            <h2 className="text-center mt-10 sm:mt-4 text-3xl sm:text-lg font-bold">
              Get Your Dream Home Decorated with Love{" "}
              <Favorite className="text-[#ed1c1c]" />
            </h2>
            <div className="text-left sm:text-left mt-5">
              <p className="text-2xl sm:text-base font-bold">
