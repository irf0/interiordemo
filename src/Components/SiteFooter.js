  ...
  return (
    <div className="border w-full bg-black flex flex-1 md:h-96 lg:h-96 h-96 justify-between">
      <div className="w-1/2 text-left ml-20 p-5 mt-5 sm:ml-5 sm:p-0 sm:mt-6">
        ...
        <p className="text-white text-left pt-5">
      ...
      <div className="w-1/2 mt-5 p-5 flex flex-col align-middle text-left">
        ...
        <button className="border-2 sm:flex sm:flex-wrap sm:overflow-hidden md:w-64 lg:w-64 xl:w-64 mt-3 border-white rounded-lg p-2 hover:border-orange-500 text-white">
          <Email />
